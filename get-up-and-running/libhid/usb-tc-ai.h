...
#define USBTC_AI_PID (0x00bb)
#define USBTEMP_AI_PID (0x00bc)

#define DIO_DIR_IN  (0x01)
#define DIO_DIR_OUT (0x00)

/* Commands and HID Report ID for USB TC-AI  */
...
#define B_2_5V     GAIN_16X // +/- 2.50 V
#define B_1_25V    GAIN_32X // +/- 1.25 V
