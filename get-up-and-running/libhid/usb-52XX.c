...
void usbDConfigPort_USB52XX(HIDInterface* hid, __u8 direction)
{
...
void usbDConfigBit_USB52XX(HIDInterface* hid, __u8 bit_num, __u8 direction)
{
    struct t_config_bit {
    __u8 reportID;
    __u8 bit_num;      
...
/* reads digital port  */
void usbDIn_USB52XX(HIDInterface* hid, __u8* value)
{
  __u8 reportID = DIN;
  struct t_read_port {
    __u8 reportID;
...
/* reads digital bit  */
void usbDInBit_USB52XX(HIDInterface* hid, __u8 bit_num, __u8* value)
{
  struct t_read_bit {
    __u8 reportID;
    __u8 value;
...
/* writes digital port */
void usbDOut_USB52XX(HIDInterface* hid, __u8 value)
{
  struct t_write_port {
    __u8 reportID;
    __u8 value;
...
/* writes digital bit  */
void usbDOutBit_USB52XX(HIDInterface* hid, __u8 bit_num, __u8 value)
{
  struct t_write_bit {
    __u8 reportID;
    __u8 bit_num;
...
void usbTin_USB52XX(HIDInterface* hid, __u8 channel, __u8 units, float *value)
{
...
void usbTinScan_USB52XX(HIDInterface* hid, __u8 start_chan, __u8 end_chan, __u8 units, float value[])
{
  int nchan;
  struct t_tinScan {
    __u8 reportID;
...
void usbBlink_USB52XX(HIDInterface* hid)
{
...
int usbReset_USB52XX(HIDInterface* hid)
{
  __u8 reportID = RESET;
...
__u8 usbGetStatus_USB52XX(HIDInterface* hid)
{
...
void usbReadMemory_USB52XX(HIDInterface* hid, __u16 address, __u8 type, __u8 count, __u8 *memory)
{
  struct t_readMemory {
    __u8 reportID;
    __u16 address;
...
int usbWriteMemory_USB52XX(HIDInterface* hid, __u16 address, __u8 type, __u8 count, __u8* data)
{
...
void usbSetItem_USB5203(HIDInterface* hid, __u8 item, __u8 subitem, float fValue)
{
  /*
    This command sets the values of the configuration items.  Because of byte alignment
    issues and the fact that some items take unsigned char and others take floats, two
  ...
  */
  ...
  switch (subitem) {
    ...
    case CH_1_COEF_3:
      ...
      PMD_SendOutputReport(hid, 0,  (__u8 *) &setItemFloat, sizeof(setItemFloat), FS_DELAY);
      break;
  default:
...
int usbGetItem_USB52XX(HIDInterface* hid, __u8 item, __u8 subitem, void* value)
{
...
void usbCalibrate_USB52XX(HIDInterface* hid)
{
  ...
  do {
    sleep(1);
    printf(".");
  } while ((usbGetStatus_USB52XX(hid) & 0x1) == 1);
  printf("\n");
}

__u8  usbGetBurnoutStatus_USB52XX(HIDInterface* hid, __u8 mask)
{
  /*
...
void usbPrepareDownload_USB52XX(HIDInterface* hid, __u8 micro)
{
  /*
...
void usbWriteCode_USB52XX(HIDInterface* hid, __u32 address, __u8 count, __u8 data[])
{
  /*
...
int usbReadCode_USB52XX(HIDInterface* hid, __u32 address, __u8 count, __u8 data[])
{
  struct t_readCode {
    __u8 reportID;
    __u8 address[3];
...
void usbWriteSerial_USB52XX(HIDInterface* hid, __u8 serial[8])
{
...
void usbConfigureLogging_USB52XX(HIDInterface* hid, __u8 options, __u8 channels, __u8 units, __u32 seconds,
				 __u16 filenumber, deviceTime starttime)
{
  ...
  if (usbGetStatus_USB52XX(hid) & DAUGHTERBOARD_PRESENT) {
...
void usbGetLoggingConfig_USB52XX(HIDInterface* hid, __u8 *options, __u8 *channels, __u8 *units, __u32 *seconds,
				 __u16 *filenumber, deviceTime *starttime)
{
  struct t_log {
    __u8 reportID;
...
void usbGetDeviceTime_USB52XX(HIDInterface* hid, deviceTime *date)
{
  /*
...
void usbSetDeviceTime_USB52XX(HIDInterface* hid, deviceTime *date)
{
  /*
    seconds   seconds in BCD range 0-59; (eg. 0x25 is 25 seconds)
    minutes   minutes in BCD range 0-59
...
void usbFormatCard_USB52XX(HIDInterface* hid)
{
  __u8 reportID = FORMAT_CARD;
  
  if (usbGetStatus_USB52XX(hid) & (DAUGHTERBOARD_PRESENT | MEMORYCARD_PRESENT)) {
    PMD_SendOutputReport(hid, 0, &reportID, 1, FS_DELAY);
  } else {
...
void usbGetFirstFile_USB52XX(HIDInterface* hid, dir_entry *entry)
{
  struct t_dirEntry {
    __u8 reportID;
    dir_entry entry;
...
void usbGetNextFile_USB52XX(HIDInterface* hid, dir_entry *entry)
{
  struct t_dirEntry {
    __u8 reportID;
    dir_entry entry;
...
void usbGetFileInfo_USB52XX(HIDInterface* hid, char *filename, dir_entry *dirEntry)
{
...
void usbGetDiskInfo_USB52XX(HIDInterface* hid, disk_info *diskInfo)
{
...
void usbDeleteFile_USB52XX(HIDInterface* hid, char *filename)
{
...
void usbGetFileHeader_USB52XX(HIDInterface* hid, char *filename, file_header *header)
{
...
void usbReadFileAck_USB52XX(HIDInterface* hid)
{
...
void usbReadFileAbort_USB52XX(HIDInterface* hid)
{
...
void usbConfigureAlarm_USB52XX(HIDInterface* hid, __u8 number, __u8 in_options, __u8 out_options, float value_1, float value_2)
{
  struct t_alarm {
    __u8 reportID;
...
void usbGetAlarmConfig_USB52XX(HIDInterface* hid, __u8 number, __u8 *in_options, __u8 *out_options, float *value_1, float *value_2)
{
