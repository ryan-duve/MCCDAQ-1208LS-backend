...
void usbBlink_USBTEMP(HIDInterface* hid)
{
...
int usbReset_USBTEMP(HIDInterface* hid)
{
  __u8 reportID = RESET;
...
void usbSetItem_USBTEMP(HIDInterface* hid, __u8 item, __u8 subitem, float fValue)
{
  /*
...
void usbCalibrate_USBTEMP(HIDInterface* hid)
{
  /*
...
void usbPrepareDownload_USBTEMP(HIDInterface* hid, __u8 micro)
{
  /*
...
void usbWriteCode_USBTEMP(HIDInterface* hid, __u32 address, __u8 count, __u8 data[])
{
  /*
...
void usbWriteSerial_USBTEMP(HIDInterface* hid, __u8 serial[8])
{
