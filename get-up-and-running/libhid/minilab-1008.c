...
void usbDConfigPort_miniLAB1008(HIDInterface* hid, __u8 port, __u8 direction)
{
...
/* reads digital port  */
void usbDIn_miniLAB1008(HIDInterface* hid, __u8 port, __u8* din_value)
{
  struct t_report {
    __u8 cmd;
    __u8 port;
...
/* writes digital port */
void usbDOut_miniLAB1008(HIDInterface* hid, __u8 port, __u8 value) 
{
  __u8 cmd[8];
...
__u8 usbDBitIn_miniLAB1008(HIDInterface* hid, __u8 port, __u8 bit) 
{
  struct t_report {
    __u8 cmd;
    __u8 port;
...
void usbDBitOut_miniLAB1008(HIDInterface* hid, __u8 port, __u8 bit, __u8 value)
{
  struct t_report {
    __u8 cmd;
    __u8 port;
...
signed short usbAIn_miniLAB1008(HIDInterface* hid, __u8 channel, __u8 range)
{
  enum Mode mode;
...
void usbAOut_miniLAB1008(HIDInterface* hid, __u8 channel, __u16 value) 
{
  __u8 cmd[8];
...
void usbAInScan_miniLAB1008(HIDInterface* hid, __u16 count, int rate, __u8 low_channel, __u8 high_channel, __u8 options, __s16 value[], __u8 gainLoadQueue[])
{
...
void usbAInLoadQueue_miniLAB1008(HIDInterface* hid, __u8 chanCount, __u8 chanLoadQueue[], __u8 gainLoadQueue[])
{
  int i;   
  struct {
    __u8 cmd;
...
void usbAInStop_miniLAB1008(HIDInterface* hid)
{
  __u8 cmd[8];
...
void usbInitCounter_miniLAB1008(HIDInterface* hid)
{
  __u8 cmd[8];
...
__u32 usbReadCounter_miniLAB1008(HIDInterface* hid)
{
  struct t_report {
    __u8 cmd;
    __u8 pad[7];
...
void usbReadMemory_miniLAB1008(HIDInterface* hid, __u16 address, __u8 *buffer, __u8 count)
{
  struct t_report {
    __u8 cmd;
    __u8 address_low;
...
void usbBlink_miniLAB1008(HIDInterface* hid)
{
  struct {
    __u8 cmd;
    __u8 pad[7];
...
int usbReset_miniLAB1008(HIDInterface* hid)
{
  __u8 cmd[8];
...
void usbSetTrigger_miniLAB1008(HIDInterface* hid, __u8 type, __u8 chan)
{
  __u8 cmd[8];
...
__u8 usbGetID_miniLAB1008(HIDInterface* hid)
{
  struct t_report {
    __u8 cmd;
    __u8 pad[7];
...
void usbSetID_miniLAB1008(HIDInterface* hid, __u8 id)
{
  __u8 cmd[8];
