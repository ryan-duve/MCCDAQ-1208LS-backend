...
#define NCHAN_1616FS  16           // max number of A/D channels in the device
#define NGAINS_1616FS  4           // max number of gain levels
...
signed short usbAIn_USB1616FS(HIDInterface* hid, __u8 channel, __u8 range, float table[NGAINS_1616FS][NCHAN_1616FS][2]);
void usbAOut_USB1616FS(HIDInterface* hid, __u8 channel, __u16 value);
void usbAOutStop_USB1616FS(HIDInterface* hid);
...
int usbAInScan_USB1616FS(HIDInterface* hid[], __u8 lowchannel, __u8 highchannel, __u32 nScan,
			 float *frequency, __u8 options, __s16 sdata[], float table_AIN[NGAINS_1616FS][NCHAN_1616FS][2], __u8 gainArray[]);
void usbAInLoadQueue_USB1616FS(HIDInterface* hid, __u8 gains[8]);
...
void usbBuildCalTable_USB1616FS(HIDInterface* hid, float table[NGAINS_1616FS][NCHAN_1616FS][2]);
