...
#define NCHAN_1608FS  8         // max number of A/D channels in the device
#define NGAINS_1608FS 4         // max number of gain levels
...
typedef struct t_Calibration_AIN {
  float slope;
  float offset;
} Calibration_AIN;
...
signed short usbAIn_USB1608FS(HIDInterface* hid, __u8 channel, __u8 range, Calibration_AIN table[NGAINS_1608FS][NCHAN_1608FS]);  
...
int usbAInScan_USB1608FS(HIDInterface* hid[], __u8 lowchannel, __u8 highchannel, __u32 count,
	 float *frequency, __u8 options, __s16 sdata[], Calibration_AIN table_AIN[NGAINS_1608FS][NCHAN_1608FS], __u8 gainArray[]);
...
void usbBuildCalTable_USB1608FS(HIDInterface* hid, Calibration_AIN table[NGAINS_1608FS][NCHAN_1608FS]);
