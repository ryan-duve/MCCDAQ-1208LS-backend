...
typedef struct t_getAllValues {
  __s16 ref_Low[4];   // Differential Inputs with reference set to the low channel
  __s16 ref_High[4];  // Differential Inputs with reference set to the low channel
  __s16 se[8];        // Single Ended inputs
  __u8  dio_portA;    // Digital Port A
  __u8  dio_portB;    // Digital Port B
} getAllValues;
