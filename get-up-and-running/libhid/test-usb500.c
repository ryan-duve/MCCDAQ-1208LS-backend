...
int read_recorded_data_USB501( usb_dev_handle *udev, configurationBlock *cblock, usb501_data *data_501 )
{
  int packet_size;
  int memory_size = 64;
  ...
  __u8 acknowledge[3] =  {0x00, 0x00, 0x00};  // Acknowledge string
  __u8 rdata[0x4000];  // max data size
...
int read_recorded_data_USB502( usb_dev_handle *udev, configurationBlock *cblock, usb502_data *data_502 )
{
  int packet_size = 512;
...
int read_recorded_data_USB503( usb_dev_handle *udev, configurationBlock *cblock, usb503_data *data_503 )
{
  int packet_size = 512;
