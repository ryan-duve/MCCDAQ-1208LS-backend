...
/* Commands and HID Report ID for USB 5201 and USB 5203 */
...
/* function prototypes for the USB-52XX */
...
void usbGetFirstFile_USB52XX(HIDInterface* hid, dir_entry *dirEntry);
void usbGetNextFile_USB52XX(HIDInterface* hid, dir_entry *dirEntry);
...
void usbReadFile_USB52XX(HIDInterface* hid, __u8 ack_count, char *filename);
